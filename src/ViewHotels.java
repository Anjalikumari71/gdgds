...
public class ViewHotels extends JFrame implements Runnable{
    ...
    public void run() {
        String[] text = new String[] {"JW Mariott Hotel", "Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel", "Classio Hotel","The Bay Club","Breeze Blow Hotel","The Taj Hotel","River View Hotel","Snow Point Hotel"};
        try {
            for(int i = 0; i <= 9; i++) {
    ...
    ViewHotels() {
        ...
        caption = new JLabel();
        caption.setBounds(50,450,600,70);
